        ...
        {news?.map(n=>(
            ...
            <a className="relative" href='#'>
                <div className="relative w-full aspect-video">
                   {n?.imageUrl.includes('mp4')||n?.imageUrl.includes('mkv')?<video src={`http://localhost:3000/public/${n?.imageUrl}`}  controls muted></video>: <img className="rounded w-full h-full object-cover"
