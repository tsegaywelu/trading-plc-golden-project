...
<form className="max-w-md mx-auto mt-16 p-4 bg-white shadow rounded" encType='multipart/form-data'>
    ...
    <div className="mb-4">
        <label htmlFor="description" className="block mb-1">Main description </label>
    ...
    <div className="mb-4">
        <label htmlFor="message" className="block mb-1">job description</label>
    ...
    <div className="mb-4">
        <label htmlFor="video" className="block mb-1">upload image or video</label>
